...
class Easy_Custom_Facebook_Feed_Widget extends WP_Widget {
	...
	public function form( $instance ) {
     ...
     <p class="widget-half">
		...
		<input class="half_field" id="<?php echo $this->get_field_id( 'cache_unit' ); ?>" name="<?php echo $this->get_field_name( 'cache_unit' ); ?>" type="number"  min="6" value="<?php echo esc_attr( $cache_unit ); ?>" size="5">  
